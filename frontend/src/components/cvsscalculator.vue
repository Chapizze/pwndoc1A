...
const cvssStrToObject = (str) => {
    ...
    for (let i = 0; i < temp.length; i++) {
      ...
      switch(elt[0]) {
        case "CVSS":
            cvssObj.value.version = elt[1];
        case "AV":
            cvssObj.value.AV = elt[1];
            break;
        case "AC":
            cvssObj.value.AC = elt[1];
            break;
        case "PR":
            cvssObj.value.PR = elt[1];
            break;
        case "UI":
            cvssObj.value.UI = elt[1];
            break;
        case "S":
            cvssObj.value.S = elt[1];
            break;
        case "C":
            cvssObj.value.C = elt[1];
            break;
        case "I":
            cvssObj.value.I = elt[1];
            break;
        case "A":
            cvssObj.value.A = elt[1];
            break;
        case "E":
            cvssObj.value.E = elt[1];
            break;
        case "RL":
            cvssObj.value.RL = elt[1];
            break;
        case "RC":
            cvssObj.value.RC = elt[1];
            break;
        case "CR":
            cvssObj.value.CR = elt[1];
            break;
        case "IR":
            cvssObj.value.IR = elt[1];
            break;
        case "AR":
            cvssObj.value.AR = elt[1];
            break;
        case "MAV":
            cvssObj.value.MAV = elt[1];
            break;
        case "MAC":
            cvssObj.value.MAC = elt[1];
            break;
        case "MPR":
            cvssObj.value.MPR = elt[1];
            break;
        case "MUI":
            cvssObj.value.MUI = elt[1];
            break;
        case "MS":
            cvssObj.value.MS = elt[1];
            break;
        case "MC":
            cvssObj.value.MC = elt[1];
            break;
        case "MI":
            cvssObj.value.MI = elt[1];
            break;
        case "MA":
            cvssObj.value.MA = elt[1];
            break;
        default:
            break;
      }
...
const cvssObjectToStr = () => {
  ...
  const orderedKeys = [
    'AV', 'AC', 'PR', 'UI', 'S', 'C', 'I', 'A', 'E', 
    'RL', 'RC', 'CR', 'IR', 'AR', 'MAV', 'MAC', 
    'MPR', 'MUI', 'MS', 'MC', 'MI', 'MA'
  ];
...
onMounted(() => {
  ...
  cvssStrToObject(cvss.value.vectorString)
});
